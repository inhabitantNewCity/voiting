          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form  class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/175.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/175.php" class="form-control" required="required"></h2>
                  </div>
                </div>
