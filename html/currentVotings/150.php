                ...
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <input type="radio" name="voit" value="radioButtonVote0"class = "textInVoiting"> sdasdsadsd<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> asdasdasdsad<Br>
                    </p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  <div class="control-group has-feedback" id="firstDiv">
                  <label class="control-label" for="inputEmail"><h2 class="textInVoiting">sefdfhggfhgfhgf</h2></label>
                  <span class="glyphicon form-control-feedback"></span>
                </div>
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/150.php" class="form-control" required="required"></h2>
                  </div>
                </div>
