          ...
          <div class="row">
                ...
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!--!@#%add-->
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="2"class = "textInVoiting"> !@#%First variants!@#%<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> !@#%Second variants!@#%<Br>
                    </p>
                    <p><input type="button" onclick="vote()" value="Submit">
                    <input type="reset" value="Resalt">
                    <input type="reset" value="Cancel"></p>
                    <input type="hidden" name = "countVoite" value="<!--countElement-->">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="<!--currentLink-->" class="form-control" required="required"></h2>
                  </div>
                </div>
                <div id="vote_status">Здесь будет ответ сервера</div>
                        ...
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="0"class = "textInVoiting"> !@#%First variants!@#%<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> !@#%Second variants!@#%<Br>
                    </p>
                    <p><input type="button" onclick="vote()" value="Submit">
