                ...
                <form onsubmit="vote()" class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!--!@#%add-->
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="radioButtonVote0"class = "textInVoiting"> !@#%First variants!@#%<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="radioButtonVote1"class = "textInVoiting"> !@#%Second variants!@#%<Br>
                    </p>
