...
x.fillRect(20,20,200,200);
  ...
  <p><b>Choose of variants:</b><Br>
   <input type="radio" name="voit" value="one"> !@#%First variants!@#%<Br>
   <input type="radio" name="voit" value="two"> !@#%Second variants!@#%<Br>
   <input type="radio" name="voit" value="three"> !@#%Therd variants!@#%<Br>
  </p>
</fieldset>
