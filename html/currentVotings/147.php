        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  <div class="control-group has-feedback" id="firstDiv">
                  <label class="control-label" for="inputEmail"><h2 class="textInVoiting">sdasdsadsd</h2></label>
                  <span class="glyphicon form-control-feedback"></span>
                </div>
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!--!@#%add-->
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="2"class = "textInVoiting"> asdasdasdsad<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> dsasadsdasdsad<Br>
                    </p>
                    <p><input type="button" onclick="vote()" value="Submit">
                    <input type="reset" value="Resalt">
                    <input type="reset" value="Cancel"></p>
                    <input type="hidden" name = "countVoite" value="3">
                    <input type="hidden" name = "voit2" value="2">
                        <!--StartCountClick-->
                    <input type="hidden" name = "voit1" value="2">
                    <!--StartCountClick-->
                    <!DOCTYPE html>
<!--
To change this license header, choose License Headers in Project Properties.
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  <div class="control-group has-feedback" id="firstDiv">
                  <label class="control-label" for="inputEmail"><h2 class="textInVoiting"></h2></label>
                  <span class="glyphicon form-control-feedback"></span>
                </div>
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!DOCTYPE html>
          ...
          <div class="row">
                ...
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!--!@#%add-->
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="2"class = "textInVoiting"> <Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> <Br>
                    </p>
                    <p><input type="button" onclick="vote()" value="Submit">
                    <input type="reset" value="Resalt">
                    <input type="reset" value="Cancel"></p>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/147.php" class="form-control" required="required"></h2>
                  </div>
                </div>
                <div id="vote_status">Здесь будет ответ сервера</div>
                        ...
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="0"class = "textInVoiting"> <Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> <Br>
                    </p>
                    <p><input type="button" onclick="vote()" value="Submit">
                    ...
                    <input type="reset" value="Cancel"></p>
                    <input type="hidden" name = "countVoite" value="3">
                    <input type="hidden" name = "voit2" value="0">
                        <!--StartCountClick-->
                    <input type="hidden" name = "voit1" value="0">
                    <!--StartCountClick-->
                    <!--addNewRadioButton-->
              </form>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                ...
                <div id="vote_status">Здесь будет ответ сервера</div>
                    ...
                    <input type="reset" value="Cancel"></p>
                    <input type="hidden" name = "countVoite" value="3">
                    <input type="hidden" name = "voit0" value="0">
                        <!--StartCountClick-->
                    <input type="hidden" name = "voit1" value="0">
                    <!--StartCountClick-->
                    <!DOCTYPE html>
