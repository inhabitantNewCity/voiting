          ...
          <div class="row">
                ...
                <form  class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting" id = "fildParent"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        ...
                        <!--!@#%start-->
                    <span id = "span0" class = "textInVoiting"><input type="radio" name="voit" id="0" value="radioButtonVote0"class = "textInVoiting"> ghjhgffghj</span>
                        <!--!@#%finish-->
                    <span id = "span1" class = "textInVoiting"><input type="radio" id="1" name="voit" value="radioButtonVote1"class = "textInVoiting"> ghjhgghjjk</span>
                    <!--!@#%add-->
                    </p>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/187.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/187.php" class="form-control" required="required"></h2>
                  </div>
                </div>
              </div>
            </div>
