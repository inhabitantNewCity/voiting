          ...
          <div class="row">
                ...
                <form  class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting" id = "fildParent"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        ...
                        <!--!@#%start-->
                    <input type="radio" name="voit" id="0" value="radioButtonVote0"class = "textInVoiting"> ewewerwer<Br>
                        <!--!@#%finish-->
                    <input type="radio" id="1" name="voit" value="radioButtonVote1"class = "textInVoiting"> dsfsdfdsfsdfd<Br>
                    <!--!@#%add-->
                    </p>
                    <p id="divSubmit"><input type="button" id = "submitVoite" onclick="vote()"  value="Submit">
                    <input type="reset" id = "resetVoit" value="Resalt">
                    <input type="reset" id="cancelVoite" value="Cancel"></p>
                    <input type="hidden" id="countVoite" name = "countVoite" value="2">
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/176.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/176.php" class="form-control" required="required"></h2>
                  </div>
                </div>
