...
<html lang="en">
 ...
 <form name="test" method="post" action="input1.php">
      ...
      <input type="radio" name="voit" value="one"> fghjkl<Br>
      
      <input type="radio" name="voit" value="one"> dfghjklwewe<Br>
      
      <!--!@#%start-->
      <input type="radio" name="voit" value="one"> sdsfsdf<Br>
      <!--!@#%finish-->
      <input type="radio" name="voit" value="two"> sdfsdfewettrtret<Br>
      <input type="radio" name="voit" value="three"> erterterter<Br>
      </p>
...
</html><input type="reset" value="Cancel"></p>
