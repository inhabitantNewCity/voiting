          ...
          <div class="row">
            <div class="col-md-4 col-lg-4">
                <form  class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <label class="control-label" for="inputEmail"><h2 class="textInVoiting">dfgdfgdfgdfg</h2></label>
                ...
                <br>
                    <p class = "textInVoiting" id = "fildParent"><b = class = "textInVoiting">Choose of variants:</b><Br><br>
                        ...
                        <!--!@#%start-->
                    <span id = "span0" class = "textInVoiting"><input type="radio" name="voit" id="0" value="radioButtonVote0"class = "textInVoiting"> dfgdfgdfgertert</span><br>
                        <!--!@#%finish-->
                    <span id = "span1" class = "textInVoiting"><input type="radio" id="1" name="voit" value="radioButtonVote1"class = "textInVoiting"> dfghjklwewe</span><br>
                    
                    <span id = "span2" class = "textInVoiting"><input type="radio" name="voit" id="2" value="radioButtonVote2"class = "textInVoiting"> dfgdfgdfgertert</span><br>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/1.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/1.php" class="form-control" required="required"></h2>
                  </div>
                </div>
              </div>
            </div>
