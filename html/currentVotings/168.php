<?php
require_once('../../php/HandlerRequestFromVoitingClass.php');
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/168.php" class="form-control" required="required"></h2>
                  </div>
                </div>
