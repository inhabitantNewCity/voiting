          ...
          <div class="row">
                ...
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <p class = "textInVoiting"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        <!--!@#%add-->
                        <!--!@#%start-->
                    <input type="radio" name="voit" value="one"class = "textInVoiting"> fghjkl<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="two"class = "textInVoiting"> dfghjklwewe<Br>
                    </p>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  <label class="control-label" class = "textInVoiting" for="inputEmail"><h2>Current link</h2></label>
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/138.php" class="form-control" required="required"></h2>
                  </div>
                </div>
            </div>
          </div>
