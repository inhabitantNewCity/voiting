          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/142.php" class="form-control" required="required"></h2>
                  </div>
                </div>
                <div id="vote_status">respounse</div>
            </div>
          </div>
        </div>
      </div>     
