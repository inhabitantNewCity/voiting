          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form onsubmit="vote()" class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <label class="control-label" for="inputEmail"><h2 class="textInVoiting">sddfsddsfds</h2></label>
                  <span class="glyphicon form-control-feedback"></span>
                </div>
                    <p class = "textInVoiting" id = "fildParent"><b = class = "textInVoiting">Choose of variants:</b><Br>
                        
                    <input type="radio" name="voit" 2 value="radioButtonVote0"class = "textInVoiting"> sdfdsfdsf<Br>
                        
                        <!--!@#%start-->
                    <input type="radio" name="voit" id="0" value="radioButtonVote0"class = "textInVoiting"> retretretertert<Br>
                        <!--!@#%finish-->
                    <input type="radio" id="1" name="voit" value="radioButtonVote1"class = "textInVoiting"> werwertyrttr<Br>
                    </p>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/173.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/173.php" class="form-control" required="required"></h2>
                  </div>
                </div>
