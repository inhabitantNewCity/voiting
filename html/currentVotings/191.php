          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
                <form  class="form-horizontal" id="createNewVoiting"  method="POST" action="javascript:void(null);">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <span id = "span2" class = "textInVoiting"><input type="radio" name="voit" id="2" value="radioButtonVote2"class = "textInVoiting"> sfsdfdfdsf</span><br>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/191.php">
                    <input type="hidden" name = "voit0" value="<--currentNumberVoit0=1-->">
                        <!--StartCountClick-->
                    <input type="hidden" name = "voit1" value="<--currentNumberVoit1=1-->">
                    <!--StartCountClick-->
                    
                    <input type="hidden" name = "voit2" value="<--currentNumberVoit2=1-->">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/191.php" class="form-control" required="required"></h2>
                  </div>
                </div>
              </div>
            </div>
