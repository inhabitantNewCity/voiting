          ...
          <div class="row">
                ...
                <form onsubmit="return false" class="form-horizontal" id="createNewVoiting"  method="POST" action="../php/SaveCurentPagePublic.php">
                  ...
                  <span class="glyphicon form-control-feedback"></span>
                    ...
                    <input type="radio" name="voit" value="radioButtonVote0"class = "textInVoiting"> asdasdasdsad<Br>
                        <!--!@#%finish-->
                    <input type="radio" name="voit" value="1"class = "textInVoiting"> vbffghgffffdg<Br>
                    </p>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/153.php" class="form-control" required="required"></h2>
                  </div>
                </div>
