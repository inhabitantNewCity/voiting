          ...
          <div class="row">
            <div class="col-md-4 col-lg-4">
                ...
                <br>
                    ...
                    <input id = "linkOnPage" type="hidden"  name="link" value="http://localhost/voting/html/currentVotings/195.php">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input id = "linkOnPage" type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/195.php" class="form-control" required="required"></h2>
                  </div>
                </div>
              </div>
            </div>
