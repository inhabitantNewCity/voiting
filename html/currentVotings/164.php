          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="control-group has-feedback">
                  ...
                  <div class="controls">
                    <h2><input type="text" id="inputEmail" name="variant1" value="http://localhost/voting/html/currentVotings/164.php" class="form-control" required="required"></h2>
                  </div>
                </div>
                <div id="vote_status">response</div>
                <div class="progress progress-success progress-striped">
                <div class="progress-bar" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 60%";></div>
              </div>
            </div>
          </div>
        </div>
